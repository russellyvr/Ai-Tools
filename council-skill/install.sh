...
echo "  3. Seats resolve at run time to each vendor's latest deep-reasoning"
echo "     flagship (Anthropic / Google / OpenAI) - no roster editing needed"
echo "     as model catalogs evolve."
